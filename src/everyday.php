...
<section class="content-detail">
    ...
    <div class="detail-content">
        ...
        <div class="detail-song">
            <!--歌单图片-->
            <div id="everyday" class="song-img">
                <p>6月19日 星期三</p>
            </div>
            <!--歌单操作按钮-->
    ...
    <div class="comment">
        ...
        <div class="write">
            ...
            <div class="input">
                <form action="" method="post">
                    <textarea rows="4" style="width: 90% ;margin-top: 10px;"></textarea>
        ...
        <!--评论展示-->
                <div class="show">
                    <?php include "../logic/comment_show2.php";?>
                </div>
    </div>
</section>
<!--4.脚注区域-->
...
<script>
    /*时间获取*/
    var date = new Date();
    $("#everyday>p").html(date.getMonth() + 1 + "月" + date.getDate() + "日" + " " + "星期" + date.getDay());
</script>
</body>
</html>